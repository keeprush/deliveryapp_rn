...
export default class NaverMapView extends Component {
    constructor() {
        ...
        this.handleOnTouch = (event) => this.props.OnTouch && this.props.onOnTouch(event.nativeEvent);
    }
    render() {
        ...
        return React.createElement(ViewClass, Object.assign({ ref: this.resolveRef }, this.props, { onInitialized: onInitialized, center: center, mapPadding: mapPadding, logoMargin: logoMargin, tilt: tilt, bearing: bearing, nightMode: nightMode, onCameraChange: this.handleOnCameraChange, onMapClick: this.handleOnMapClick, OnTouch: this.handleOnTouch}));
    }
}
